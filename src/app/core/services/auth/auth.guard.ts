...
import { IAuthStatus } from '../../model/IAuthStatus'
...
export class AuthGuard implements CanActivate, CanActivateChild, CanLoad {
  ...
  canLoad(route: Route): boolean | Observable<boolean> | Promise<boolean> {
    console.log('AuthGuard canLoad !!!!!!!!!!!!!!!!! 1');
  ...
  canActivate(
    ...
    console.log('AuthGuard canActivate !!!!!!!!!!!!!!!!! 2');
  ...
  canActivateChild(
    ...
    console.log('AuthGuard canActivateChild !!!!!!!!!!!!!!!!! 3');
  ...
  protected checkLogin(route?: ActivatedRouteSnapshot) {
    ...
    if (route) {
      ...
      console.log('AuthGuard checkLogin !!!!!!!!!!!!!!!!! 5 expectedRole = ' + expectedRole + ' roleMatch = ' + roleMatch);
       
      if (expectedRole) {
        roleMatch = this.currentAuthStatus.userRole === expectedRole
      }

      console.log('AuthGuard checkLogin !!!!!!!!!!!!!!!!! 6 expectedRole = ' + expectedRole + ' roleMatch = ' + roleMatch);
